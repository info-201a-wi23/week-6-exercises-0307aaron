...
mean(race_wealth$wealth_family, na.rm = TRUE)
...
ggplot(data = total_avg_wealth) + geom_line(mapping = aes(x = year, y = avg_wealth))

# Let's plot family wealth over time by racial category

ggplot(data = race_wealth) + geom_point(mapping = aes(x = year, y = wealth_family, color = race)) + geom_line(aes(x = year, y = wealth_family, color = race))
...
ggplot(data = avg_race_wealth) + geom_point(mapping = aes(x = year, y = wealth_family, color = race)) + geom_line(aes(x = year, y = wealth_family, color = race))
